...
["Immune"] = "I tried to cast %s on you but you're immune!",

["LowMana"] = "I'm low on mana and may not be able to heal!",

["ExternalCD"] = ">> Used %s on %s! <<",

["UIimmune"] = "Target Immune?",

["UIimmunehelp"] = "Check to whisper players if you try to heal/buff them but they are immune.",

["UIlowmana"] = "Low Mana?",

["UIlowmanahelp"] = "Check to broadcast to your group when your mana drops below the threshold.",

["UIlowmanathreshold"] = "% threshold",

["UIexternalcds"] = "Announce Externals?",

["UIexternalcdshelp"] = "Check to announce to your group when you use an external cooldown (Ironbark, Pain Suppression, etc.).",
